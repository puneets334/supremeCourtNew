    ...
    $('#add_petitioner').validate({
        ...
        rules: {
            pet_org_id: {
                ...
                minlength: 3,
                required: "#pet_not_in_list:checked",
                valid_address: true
            }, pet_complainant: {
                minlength: 3,
                required: true,
                ...
                required: '#pet_state_req[value="1"]'
            }, pet_district: {
                required: '#pet_dist_req[value="1"]'
            }
        },
        messages: {
            pet_org_id: {
