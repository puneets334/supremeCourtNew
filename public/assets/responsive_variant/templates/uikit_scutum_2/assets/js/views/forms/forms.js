...
scutum.forms.controls.init = function () {
	...
	// input masks
	scutum.forms.controls.inputMask();
	// datepicker
	scutum.forms.controls.datePicker();
	// daterangepicker
...
scutum.forms.controls.inputMask = function (input) {
...
scutum.forms.controls.datePicker = function (wrapper) {
