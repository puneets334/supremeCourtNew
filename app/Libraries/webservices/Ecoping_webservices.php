...
/* Prisoner Module */
  ...
  public function getCopyRequest($id){
    ...
    public function copyFaq(){
        $data = curl_get_contents(ICMIS_SERVICE_URL."/api/online_copying/copy_faq/");
        if ($data != false) {
            return json_decode($data,true);
        } else {
            return NULL;
    ...
    public function getCatogoryForApplication($idd){
        $data = curl_get_contents(ICMIS_SERVICE_URL."/api/online_copying/get_catogory_for_application/?idd=$idd");
        if ($data != false) {
            return json_decode($data,true);
        } else {
            return NULL;
