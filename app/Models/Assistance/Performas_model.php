...
class Performas_model extends Model {
    ...
    function insert_news($array, $file_temp_name) {
        ...
        // $this->db->INSERT('efil.tbl_performas', $array);
        if ($this->db->insertID()) {   
    ...
    function update_news_by_id($id, $data_update, $file_temp_name = null) {
        ...
        // pr($query->affectedRows());
        // $this->db->WHERE('id', $id);
        // $this->db->UPDATE('efil.tbl_performas', $data_update);
    ...
    function notice_circulars_list() {
        // $this->db->SELECT('*');
        // $this->db->FROM('efil.tbl_performas');
