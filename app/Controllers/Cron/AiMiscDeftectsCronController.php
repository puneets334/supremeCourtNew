...
class AiMiscDeftectsCronController extends CI_Controller {
    ...
    public function index()
    {
        ...
        $cronDetailsId=$this->AiMiscDeftectsCron_model->insertInDBwithInsertedId('efil.tbl_cron_details',$cronDetails);
            ...
            //$stage_ids = [Document_E_Filed, IA_E_Filed]; // 14=> Misc. Document E-Filed,  26=> IA E-filed
            $case_type = [E_FILING_TYPE_IA]; // 4 => IA
                ...
                if ($scrutiny_result) {
                    //echo '<pre>';print_r($scrutiny_result);exit();
                    ...
                    //$message = $stage_id == 14 ? 'Misc. Document E-Filed' : 'IA E-filed';
