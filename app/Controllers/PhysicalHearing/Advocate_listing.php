...
class Advocate_listing extends CI_Controller
{
    ...
    public function advocate_rpt()
    {
        ...
        $this->load->view('physical_hearing/advocate_rpt',$data);
    }
    ...
    public function advocate_rpt_vc($listing_date=null)
    {
        ...
        $this->load->view('physical_hearing/advocate_rpt_vc_ajax',$data);
    }
    ...
    public function advocate_rpt_srch()
    {
        ...
        {
            $this->load->view('physical_hearing/menu');
            $this->load->view('physical_hearing/advocate_rpt_vc', $this->data);
        }
