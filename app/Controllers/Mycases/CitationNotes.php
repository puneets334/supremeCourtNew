...
class CitationNotes extends BaseController
{
    ...
    public function add_case_contact()
    {
        ...
        $citationNotesModel = new CitationNotesModel();
        ...
        if (empty($contact_id)) {
            ...
            $result = $citationNotesModel->add_case_contact_data($data);
            if ($result) {
            ...
            $result = $citationNotesModel->update_case_contact_data($data, $contact_id);
            if ($result) {
    ...
    public function get_contact_list()
    {
        ...
        $citationNotesModel = new CitationNotesModel();
        $result = $citationNotesModel->get_case_contact_data($session->get('login.id'), $dno);
    ...
    public function case_contact()
    {
        ...
        $citationNotesModel = new CitationNotesModel();
        $results = $citationNotesModel->get_cnr_case_contact_data($id);
    ...
    public function delete_contacts()
    {
        ...
        if (!empty($id)) {
            $citationNotesModel = new CitationNotesModel();
            $result = $citationNotesModel->delete_contacts($id);
            if ($result) {
    ...
    function aor_contact_list()
    {
        ...
        $aor_contact = $this->CitationNotesModel->get_aor_contact();
