...
class Efiled_cases extends namespace App\Controllers; {

    public function __construct() {
        parent::__construct();

        //Loading common libraries and helpers
        ...
        $this->load->model('adminDashboard/Efiled_cases_model');
        $this->load->model('newcase/New_case_model');
        $this->load->model('newcase/Stageslist_model');
    ...
    function manage_records_for_NewCase($estblishment_data, $efiling_nums, $current_date_n_time, $cron_update, $admin_update) { //echo "bvv"; die;
//echo "<pre>"; print_r($estblishment_data); die;
        $accepted_count = 0;
        ...
        //echo "<pre>"; print_r($new_case_records); die;
    ...
    function call_new_case_cis_status_webservice($establishment_code, $efiling_for_type_id, $available_efiling_nums, $establishment_state_code, $count_cis) {
        ...
        if ($batch_remainder > 0) {
            ...
            if ($batch_remainder == 1) {
                ...
                //echo "<pre>";  print_r($data[$i]->consumed_data);             die;
                //$a = $data[$i]['ROW'];
