...
class view extends BaseController {
    ...
    public function __construct() {
        ...
        $this->load->model('acknowledgement/Acknowledgement_model');
    ...
    public function index() {
        ...
        if ($_SESSION['efiling_details']['ref_m_efiled_type_id'] == E_FILING_TYPE_NEW_CASE) {
            ...
            $data['view_data'] = array(
                ...
                'create_on' => date('d-m-Y H:i:s A', strtotime($efiling_civil_data[0]['create_on'])),
                'pet_name' => $title[0],
                'res_name' => $title[1],
                'total_ia' => $get_IA,
                'ref_file_no' => 'NA',
                ...
                'urgent' => $efiling_civil_data[0]['urgent'],
                'bench_name' => $efiling_civil_master[0]->bench_name,
        ...
        $content = $this->load->view('acknowledgement/case_preview_pdf', $data, TRUE);

        ob_start();
        $pdf = new PDFDOC(PDF_PAGE_ORIENTATION, PDF_UNIT, PDF_PAGE_FORMAT, true, 'UTF-8', false);
