    ...
    <div class="panel-body">
        ...
        <div class="row">
            <div class="col-sm-12 col-xs-12">
                ...
                if($subordinate_court_details[0]['case_type']==0 || $subordinate_court_details[0]['case_type']==''){$case_type_id_zero='block;'; }else{ $case_type_id_zero='none;';}
                ...
                $hcchecked = $court_type == '3' ? 'checked="checked"' : '';
                $dcchecked = $court_type == '1' ? 'checked="checked"' : '';
                $dcchecked = $court_type == '5' ? 'checked="checked"' : '';
                if ($court_type==1){ //District Court or Lower Court

                    $court_type_name='District Court (Lower Court)';

                }elseif ($court_type==2){

                    $court_type_name='Other Court';

                }elseif ($court_type==3){ //High Court

                    $court_type_name='High Court';

                }elseif ($court_type==4){ //Supreme Court

                    $court_type_name='Supreme Court';

                }elseif ($court_type==5){ //State Agency
                ...
                <div id="hc_entry_div">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-7 col-sm-12 col-xs-12">
                                            <select name="sci_case_type_id" tabindex = '4' id="sci_case_type_id" class="form-control input-sm filter_select_dropdown" style="width: 100%">
                                                ...
                                                <?php $sel = ($subordinate_court_details[0]['case_type'] ==0) ? 'selected=selected' : '';
                                                echo '<option '.$sel.' value="' . escape_data(url_encryption( "0##NOT IN LIST")) . '">NOT IN LIST</option>';
                                                foreach ($case_type_list as $case_type){
                                                    $sel = ($case_type->casecode == $subordinate_court_details[0]['case_type']) ? 'selected=selected' : '';
                                                    ?>
                    ...
                    <div id="high_court_info" style="display: block;">
                        ...
                        <div class="col-sm-4 col-xs-12">
                            <div class="form-group">
                                <label class="control-label col-md-12 col-sm-12 col-xs-12 input-sm">High Court :<?php echo $subordinate_court_details[0]['highCourtName'];?></label>
                        ...
                        <div class="col-sm-4 col-xs-12">
                            <div class="form-group">
                                <label class="control-label col-md-12 col-sm-12 col-xs-12 input-sm">Bench :<?php echo $subordinate_court_details[0]['benchName'];?></label>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-7 col-sm-12 col-xs-12">
                                    <select tabindex = '8' name="case_type_id" id="case_type_id" class="form-control input-sm filter_select_dropdown" style="width: 100%">
                                        ...
                                        echo '<option '.$sel.' value="' . escape_data(url_encryption( "0##NOT IN LIST")) . '">NOT IN LIST</option>';
                                        foreach ($case_type_list as $case_type){
                                            $sel = ($case_type['case_type'] == $subordinate_court_details[0]['case_type']) ? 'selected=selected' : '';
                                            ?>
                  ...
                  <?php } else if ($court_type==5){?>
                    <div id="state_agency_info" style="display: block;">
                        <div class="col-sm-4 col-xs-12">
                            <div class="form-group">
                                <label class="control-label col-md-12 col-sm-12 col-xs-12 input-sm">State :<?php echo $subordinate_court_details[0]['agency_state'];?></label>
                            </div>
                        </div>

                        <div class="col-sm-4 col-xs-12">
                            <div class="form-group">
                                <label class="control-label col-md-5 col-sm-12 col-xs-12 input-sm">Agency :<?php echo trim($subordinate_court_details[0]['agency_name']);?></label>
                            </div>
                        </div>
       ...
       // get_fir_state_list();
        ...
        $('#update_subordinate_court_details').on('submit', function () {
            ...
            if ($('#update_subordinate_court_details').valid()) {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url('caveat/Subordinate_court/update_subordinate_court'); ?>",
                    data: form_data,
                    async: false,
                    beforeSend: function () {
