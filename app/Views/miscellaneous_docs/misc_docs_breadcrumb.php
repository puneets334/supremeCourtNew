                ...
                <div class="col-12 col-sm-12 col-md-12 col-lg-12 ">
                    <div class="crnt-page-head">
                        <div class="current-pg-title">
                            <?php if((getSessionData('customEfil') == 'refile')){?> <h6>Refile Old Efiling Cases</h6> <?php } elseif (getSessionData('customEfil') == 'misc') { ?><h6>E-File Miscellaneous Documents</h6> <?php } ?>
                        </div>
