                        ...
                        <div class="x_content">
                            ...
                            <ul class="nav-breadcrumb">
                                ...
                                <li>  
                                    ...
                                    ?>
                                    <a href="<?= $appearing_url; ?>" class="<?php echo $status_color; ?>" style="z-index:8; <?php if(!in_array(MISC_BREAD_CASE_DETAILS, $StageArray)){ echo $disabled_status;} ?>"><span style="<?php echo $ColorCode; ?>">2</span> Appearing for</a>

                                </li>
                                <li>  

                                    <?php
                                    if ($this->uri->segment(1) == 'on_behalf_of') {
                                        $ColorCode = 'background-color: #01ADEF';
                                        $status_color = 'first active';
                                    ...
                                    ?>
                                    <a href="<?= $onbehlaf_url; ?>" class="<?php echo $status_color; ?>" style="z-index:7; <?php if(!in_array(MISC_BREAD_APPEARING_FOR, $StageArray)){ echo $disabled_status;} ?>"><span style="<?php echo $ColorCode; ?>">3</span> Filing For</a>
                                ...
                                <li>  
                                    ...
                                    ?>
                                    <a href="<?= $doc_index_url ?>" class="<?php echo $status_color; ?>" style="z-index:6; <?php if(!in_array(MISC_BREAD_ON_BEHALF_OF, $StageArray)){ echo $disabled_status;} ?>"><span style="<?php echo $ColorCode; ?>">4</span> Upload Document / Index</a>
...
/*                                    if ($this->uri->segment(1) == 'documentIndex') {
                                ...
                                <li>  
                                    ...
                                    ?>
                                    <a href="<?= $fee_url; ?>" class="<?php echo $status_color; ?>" style="z-index:4; <?php if(!in_array(MISC_BREAD_DOC_INDEX, $StageArray)){ echo $disabled_status;} ?>"><span style="<?php echo $ColorCode; ?>">5</span> Court Fee   </a>
                                ...
                                <!--<li>
                                    ...
                                    <?php
/*
                                    if ($this->uri->segment(1) == 'shareDoc') { //Modify the code on 1 feb 21 to show tab selected on its click
                                        $ColorCode = 'background-color: #01ADEF';
                                        $status_color = 'first active';
...
/*                                    if ($this->uri->segment(1) == 'affirmation') {
                                ...
                                <li> 
                                    ...
                                    ?>
                                    <a href="<?= base_url('miscellaneous_docs/view') ?>" class="<?php echo $status_color; ?>" style="z-index:1;"><span style="<?php echo $ColorCode; ?>">7</span> View </a>
                                </li>
                            </ul>
                            <div class="clearfix"></div> 
                            <br/>
