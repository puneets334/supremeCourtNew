...
<html lang="en">
    <head>
        ...
        <!-- multiselect -->
        <?php
        if(uri_string() == 'documentSharingWithProof' || uri_string() == 'case/iamiscdocshare' || uri_string() == 'documentSharingWithProof/DefaultController/searchCaseByDiaryRegistration' || uri_string() == 'documentSharingWithProof/DefaultController/uploadDocumentForSharing')
        {
            ?>
            <script type="text/javascript" src="<?= base_url('assets/js/jquery-main.js'); ?>"></script>
        ...
        <?php  }
            ...
            <script type="text/javascript" src="<?= base_url('assets/js/jquery_2.2.3_min.js'); ?>"></script> <!-- for support select2js-->
        <?php  }
        ?>
    ...
    <body class="nav-sm"  style="background-color:<?php echo $bg_color; ?>">
        ...
        <div class="container-fluid body" >
            <div class="main_container">
                <?php if(false){ ?><!--for responsive_variant-->
                    <div class="col-md-3 left_col " style="background-color:<?php echo $bg_border; ?>">
                        <div class="left_col scroll-view" style="menbackground-color:<?php echo $bg_color; ?>">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-10 col-md-10 col-md-offset-1">
                                                    <ul class="legend list-unstyled">
                                                        <li> <a href="<?= base_url('dashboard'); ?>" class="btn btn-default btn-xs" style=" width: 100%;text-align: left;"><i class="fa fa-home"></i> Home</a>
                                                        <li> <a href="<?php echo base_url('newcase/defaultController'); ?>" class="btn btn-default btn-xs " style=" width: 100%;text-align: left;"><i class="fa fa-database"></i> e-File</a> </li>
                                        ...
                                        <div class="col-xs-12 top_search show_sm_div visible-sm visible-xs" >
                                            <div class="btn-group"  style="float:right;"    >
                                                <ul class="legend list-unstyled">
                                                    ...
                                                    <li> <a href="<?php echo base_url('newcase/defaultController'); ?>" class="btn btn-default btn-xs" style="width: 100px;"><i class="fa fa-database"></i> e-File</a> </li>
                                                    <li> <a href="<?= base_url('dashboard'); ?>" class="btn btn-default btn-xs" style="width: 100px;"><i class="fa fa-home"></i> Home</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
            ...
            <script>
                ...
                function updateUploadFileName(upload_field_Id){
                    ...
                    if(file_type == 'application/pdf' && file_size <= max_file_size){
                        ...
                        file_data.append('caveateDocNum',caveateDocNum);
                        return file_data;
                    }
                    else{
