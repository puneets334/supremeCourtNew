...
<footer class="footer">
    <div style="text-align: center">
        <strong>Copyright &copy; 2018-2019 <a href="#">eCommittee, Supreme Court of India</a>.</strong> All rights
        reserved.
    </div>
    <div class="clearfix"></div>
</footer>
...
<!--<link href="<?php /*echo base_url(); */?>dataTables/jquery.dataTables.css" rel="stylesheet" />-->
<link href="<?php echo base_url(); ?>dataTables/buttons.dataTables.css" rel="stylesheet" />
<script src="<?= base_url() . 'assets' ?>/vendors/datatables.net/js/jquery.dataTables.min.js"></script>
<script src="<?php echo base_url(); ?>dataTables/jszip.min.js"></script>
<script src="<?php echo base_url(); ?>assets/responsive_variant/templates/uikit_scutum_2/node_modules/datatables.net-buttons/js/dataTables.buttons.min.js"></script>
<script src="<?php echo base_url(); ?>dataTables/pdfmake.min.js"></script>
<script src="<?php echo base_url(); ?>dataTables/vfs_fonts.js"></script>
<script src="<?php echo base_url(); ?>assets/responsive_variant/templates/uikit_scutum_2/node_modules/datatables.net-buttons/js/buttons.html5.min.js"></script>
...
<script type="text/javascript">
    ...
    $(".pending_scrutiny_status").submit(function (e) {
        ...
        var efiling_for_type_id = '<?php echo $_SESSION['efiling_details']['ref_m_efiled_type_id']; ?>';
        if (efiling_for_type_id == 1) {
            var status_url = '<?= base_url('Efiled_cases/check_pending_scrutiny_status/') ?>';
            var redirect_url = '<?= base_url('new_case/view') ?>';
        } else if (efiling_for_type_id == 4) {
            status_url = '<?= base_url('Efiled_cases/check_pending_scrutiny_status_ia/') ?>';
            redirect_url = '<?= base_url('IA/view') ?>';
        } else {
    ...
    $("#pass_update_formwww").submit(function () {
        ...
        {
            $(this).find('#currentpass').val(sha256(sha256($(this).find('#currentpass').val()) + '<?= $_SESSION['login_salt'] ?>'));
