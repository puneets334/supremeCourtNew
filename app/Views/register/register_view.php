                    ...
                    <div class="uk-width-1-3@m">
                        ...
                        <div class="uk-width-medium uk-padding-small uk-position-z-index uk-back" uk-scrollspy="cls: uk-animation-fade">
                            ...
                            <div id="ekyc_upload_share" style="display: none;">
                                ...
                                <center>   
                                    <div> 
                                        ...
                                        <a class="uk-button uk-button-default" style=" padding: 0 5px; line-height: 26px; font-size: 18px;text-transform: capitalize;">
                                            <input class="uk-radio" type="radio" checked id="new_advocate" onclick="HideEkycDiv('offline_proceed')" name="not_register_type_user" value="<?php echo htmlentities(url_encryption('not_register_ekyc'), ENT_QUOTES); ?>" >
                                            <label for="new_advocate" style="margin:1px;">Offline</label>
                                        </a>
                                        <a class="uk-button uk-button-default" style=" padding: 0 5px; line-height: 26px;font-size: 18px;text-transform: capitalize;">
                                            <input class="uk-radio" type="radio" id="ekyc" onclick="showHideDiv('ekyc_upload_share')" name="not_register_type_user"  value="<?php echo htmlentities(url_encryption('not_register_other'), ENT_QUOTES); ?>" >
                                            <label for="ekyc" style="margin:1px;">Paperless KYC </label>
                                        </a>
                                    </div>
                                </center>
                                <br> 
                                ...
                                <div  class="uk-width-medium uk-padding-small uk-position-z-index uk-back" uk-scrollspy="cls: uk-animation-fade">
                                    ...
                                    <fieldset class="uk-fieldset" >
                                        <center>
                                            ...
                                            <a class="uk-button uk-button-primary" target="_blank" href="https://resident.uidai.gov.in/offlineaadhaar" style="font-size: 12px;">Visit to Download Offline Aadhaar Zip File</a>
                                            <i style="padding: 0px; font-size: 44px;" class="uk-button uk-button-default font_size" uk-tooltip="Enter ‘Aadhaar Number’ or ‘VID’ and mentioned ‘Security Code’ in screen, then click on ‘Send OTP’ or ‘Enter TOTP’. The OTP will be sent to the registered Mobile Number for the given Aadhaar number or VID. TOTP will be available on m-Aadhaar mobile Application of UIDAI. Enter the OTP received/TOTP. Enter a Share Code which be the password for the ZIP file and click on ‘Download’ button
                                               The Zip file containing the digitally signed XML will be downloaded to device wherein the above mentioned steps have been performed.">?</i>
                                            <div class="uk-margin-small">
                                                <span>Choose Offline Aadhaar Zip File (max size 5mb).</span>
                                                <div class="uk-inline uk-width-1-1">
                                                    <input class="uk-button uk-button-primary" type="file" id="ekyc_zip_file" required name="ekyc_zip_file" style="border-radius: 20px;">
                                                </div>
                                            </div> 
                                        </center>
                                        <div class="uk-margin-small">
                                            <div class="uk-inline uk-width-1-1">
                                                ...
                                                <input class="inpt uk-input uk-border-pill uk-input-custom" type="password" name="share_code"  placeholder="Share Code" autofocus  autocomplete="off" minlength="4" maxlength="6" required>
                                            </div>
                                        </div>
                            ...
                            <div id="offline_proceed" > 
                                ...
                                <center>
                                    <div> 
                                        <input type="text" name="adv_type_select" id="adv_type_select" value="<?php echo htmlentities(url_encryption('1'), ENT_QUOTES); ?>">
