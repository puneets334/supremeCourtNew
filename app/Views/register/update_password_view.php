                ...
                <div class="uk-grid" data-ukgrid style="width: -webkit-fill-available;">
                    ...
                    <div class="uk-width-1-3@m">
                        ...
                        <div class="uk-width-medium uk-padding-small uk-position-z-index uk-back" uk-scrollspy="cls: uk-animation-fade">
                            ...
                            <center><h4> <strong><?php echo $title; ?> </strong></h4></center>
                                ...
                                <fieldset class="uk-fieldset"> 
                                    <div class="uk-margin-small">
                                        <div class="uk-inline uk-width-1-1">
                                            ...
                                            <input class="inpt uk-input uk-border-pill uk-input-custom" type="password" id="password" maxlength="20" autocomplete="off" name="password" placeholder="Password" >
                                    ...
                                    <div class="uk-margin-small">
                                        <div class="uk-inline uk-width-1-1">
                                            <span class="uk-form-icon uk-form-icon-flip" data-uk-icon="icon: lock"></span>
                                            <input class="inpt uk-input uk-border-pill uk-input-custom" type="password" id="confirm_password" autocomplete="off" maxlength="20" name="confirm_password" placeholder="Confirm Password" >
                                    ...
                                    <div class="uk-margin-bottom">
                                        <button type="submit" class="uk-button uk-button-primary uk-border-pill uk-width-1-1" name="btn_login" value="register" class="uk-button uk-button-primary uk-border-pill uk-width-1-1"> UPDATE PASSWORD</button>
                                    </div> 
                                </fieldset>
                                <?php echo form_close(); ?>
