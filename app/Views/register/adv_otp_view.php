                ...
                <div class="uk-grid" data-ukgrid style="width: -webkit-fill-available;">
                    ...
                    <div class="uk-width-1-3@m">
                        ...
                        <div class="uk-width-medium uk-padding-small uk-position-z-index uk-back" uk-scrollspy="cls: uk-animation-fade">
                            ...
                            ?>   
                            <center><h4 style="margin: 0;"> <strong><?php echo $_SESSION['adv_details']['register_type']; ?></strong></h4>
                                <h5 style="color: green; margin: 0;"> OTP Send (Verify)</h5> </center><br>
                            ...
                            <div  class="uk-width-medium uk-padding-small uk-position-z-index uk-back" uk-scrollspy="cls: uk-animation-fade">
                                ...
                                <fieldset class="uk-fieldset">
                                    <?php if ($_SESSION['adv_details']['mobile_no']) { ?>
                                        <div class="uk-margin-small">
                                            <div class="uk-inline uk-width-1-1">
                                                <span class="uk-form-icon uk-form-icon-flip" data-uk-icon="icon: user"></span>&nbsp;&nbsp; Mobile : <span style="color:green;"><?php echo $_SESSION['adv_details']['mobile_no']; ?></span> 
                                                <!--<input class="inpt uk-input uk-border-pill uk-input-custom" type="text" value="<?php /*echo $_SESSION['adv_details']['mobile_otp']; */?>" name="adv_mobile_otp"  placeholder="Enter Mobile OTP" maxlength="6" minlength="6" autofocus  autocomplete="off" >-->
                                                <input class="inpt uk-input uk-border-pill uk-input-custom" type="text" value="" name="adv_mobile_otp"  placeholder="Enter Mobile OTP" maxlength="6" minlength="6" autofocus  autocomplete="off" >

                                                <?php echo form_error('adv_mobile_otp'); ?> 
                                            </div>
                                        </div>  
                                    <?php } ?>
                                    <?php if ($_SESSION['adv_details']['email_id']) { ?>
                                        <div class="uk-margin-small">
                                            <div class="uk-inline uk-width-1-1"> 
                                                ...
                                                &nbsp;Email Id : <span style="color:green;"><?php echo $_SESSION['adv_details']['email_id']; ?></span> 
                                                <!--<input class="inpt uk-input uk-border-pill uk-input-custom" type="text" value="<?php /*echo $_SESSION['adv_details']['email_otp']; */?>" id="adv_email_otp" autocomplete="off" name="adv_email_otp" maxlength="6" minlength="6" placeholder="Enter Email OTP" >-->

                                                <input class="inpt uk-input uk-border-pill uk-input-custom" type="text" value="" id="adv_email_otp" autocomplete="off" name="adv_email_otp" maxlength="6" minlength="6" placeholder="Enter Email OTP" >
                                                <?php echo form_error('adv_email_otp'); ?> 
                                            </div>
                                        </div> 
                                    <?php } ?>
                                    ...
                                    <div>
                                        ...
                                        <input type="text" autocomplete="off" name="userCaptcha" placeholder="Captcha" maxlength="6" minlength="6" class="inpt uk-input uk-border-pill uk-input-custom" value="<?php echo $captcha['word']; ?>" style="width:225px;float: right;">
                                        <?php echo form_error('userCaptcha'); ?> 
                                    </div> 
                                    <br>
                                    <div class="uk-margin-bottom">
                                        <button type="submit" class="uk-button uk-button-primary uk-border-pill uk-width-1-1" name="btn_login" value="verifyadvOtp" class="uk-button uk-button-primary uk-border-pill uk-width-1-1"> Verify</button>
                                    </div> 
                                </fieldset>
                                <?php echo form_close(); ?>
                        ...
                        <center>   
                            Resend OTP ? <a href="<?php echo base_url('register/AdvOtp/resend_otp') ?>">click</a> 
                        </center>
