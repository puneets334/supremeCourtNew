                                   ...
                                   // echo "1";exit();
                                    ...
                                    if ($re->ref_m_efiled_type_id == E_FILING_TYPE_MISC_DOCS) {
                                       ...
                                       // echo "5"; exit();
                                        ...
                                        $button_label="Register IA";
                                        $lbl_for_doc_no = '<b>IA Diary No.</b> : ';
                                        $case_details="sunny bhai";
                                        $redirect_url = base_url('deficitCourtFee/DefaultController');
                                    }*/
                                    else {
                                        $type = 'Mentioning';
                                        $lbl_for_doc_no = '';
                               ...
                               /* elseif ($re->stage_id == DEFICIT_COURT_FEE_PAID){*/
                                ...
                                <tr>
                                    ...
                                    if ($stages == New_Filing_Stage) {
                                        ...
                                        <?php if ($_SESSION['login']['userid'] != SC_ADMIN){
                                ...
                                <td width="14%"><a href="<?= $redirect_url . '/' . url_encryption(trim($re->registration_id . '#' . $re->ref_m_efiled_type_id . '#' . I_B_Approval_Pending_Admin_Stage . '#' . $re->efiling_no)) ?>"> <?php echo htmlentities(efile_preview($re->efiling_no, ENT_QUOTES)) ?></a></td>
                                <td width="12%"><?php echo htmlentities($type, ENT_QUOTES) ?></td>                                                                    
                                <td><?php echo $case_details; ?></td>
                                <td width="12%"><?php echo date("d/m/Y h.i.s A", strtotime(htmlentities($re->activated_on, ENT_QUOTES))); ?></td>
                                <td width="14%">
