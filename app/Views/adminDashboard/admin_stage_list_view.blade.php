                            ...
                            <table id="datatable-responsive" class="table table-striped custom-table" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    ...
                                    foreach ($result as $re) {
                                        ...
                                        /* elseif ($re->stage_id == DEFICIT_COURT_FEE_PAID){*/ elseif ($re->stage_id == DEFICIT_COURT_FEE_E_FILED) {
                                        ...
                                        <tr>
                                            ...
                                            ?>
                                                ...
                                                <?php if (getSessionData('login')['userid'] != SC_ADMIN) {
                                                    ...
                                                    // if (isset($re->is_register) && $re->is_register == 1 || isset($re->is_register) && $re->is_register == '') { ?>
                                                ...
                                                <?php
                                                    // }
                                                    if (isset($re->account_status) && $re->account_status == 1 || isset($re->account_status) && $re->account_status == 0) { ?>
