                    ...
                    <div class="x_panel">
                        <div class="x_title">
                            <div class="registration-process" style="float: left; border: none;">
                                <h2><i class="glyphicon glyphicon-book"></i> E-File Mentioning </h2>
                                <div class="clearfix"></div>
                            </div>
                        ...
                        <div class="x_content">
                            ...
                            <ul class="nav-breadcrumb">
                                ...
                                <li>  
                                    ...
                                    <?php
                                    if ($this->uri->segment(1) == 'listing' || $this->uri->segment(1)=='mentioning') {
                                        $ColorCode = 'background-color: #01ADEF';
                                        $status_color = 'first active';
                                    ...
                                    ?>
                                    <a href="<?= $listing; ?>" class="<?php echo $status_color; ?>" style="z-index:7;"><span style="<?php echo $ColorCode; ?>">2</span> Listing</a>
