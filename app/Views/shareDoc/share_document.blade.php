                ...
                <div class="form-group">  
                    <div class="table-responsive">  
                        <table class="table table-bordered" id="dynamic_field">  
                            <tr>  
                                <td><input type="text" name="name" id="name" placeholder="Enter  Name" class="form-control name_list " minlength="3" /> <ul id="searchResult_1"></ul></td>
            ...
            <div class="row" id="case_aor_con" >
                <div class="form-group">
                    <div class="table-responsive">
                        <table class="table table-bordered" id="dynamic_field">
                            <?php
                            pr($case_aor_contacts);
                            foreach($case_aor_contacts['advocates_list'] as $contacts){
                                ?>
                            <tr>
                                <td><input readonly type="text" name="name" id="name" placeholder="Enter  Name" class="form-control name_list " value="<?=$contacts['name']?>" /> <ul id="searchResult_1"></ul></td>
        ...
        $('#add_share_email').on('submit', function () {
           ...
           // alert(is_contact); //return false;
            if ($('input[name="contact"]:checked').val() == 1) {
                ...
                var form_data = {name: name, email: email,contact:is_contact};
            }
            ...
            if ($('input[name="contact"]:checked').val() == 3) {
                ...
                var email = resArr[2];
                var form_data = {name: ad_name, email: email,contact:is_contact};
            }
            if($('input[name="contact"]:checked').val() == 4){
                ...
                var form_data = {case_aor_cotacts:val,contact:is_contact};
                //return false;
            }
