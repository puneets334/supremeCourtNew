                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-12 col-xs-12" style="margin-top: 30px;">
                                            <div style="width: fit-content;padding-left: 10px;">
                                                ...
                                                <button type="button" class="btn btn-lg btn-primary"> Pending With Advocate/PIP <span class="badge"><?=$pending_with_aor?></span></button>
                                                <button type="button" class="btn btn-lg btn-danger"  data-toggle="modal" data-target="#myModal"> Pending With Registry <span class="badge"><?=$pending_with_registry?></span></button>
                                            </div>
                                        </div>
                                        <div class="container">
                                ...
                                <div class="col-sm-4 col-xs-12">
                                    <div class="form-group">
                                        <div class="col-sm-12 col-xs-12" style="margin-top: 30px;">
                                            <div style="width: fit-content;padding-left: 10px;">
                                                <label class="radio-inline"> Last Updated On : <span style="color: blue"> <?=$last_updated_on!='0'?date('d-m-Y h:i:s A',strtotime($last_updated_on)):date('d-m-Y h:i:s A')?> </span></label>
                                            </div>
                                        </div>
                                        <div class="container">
