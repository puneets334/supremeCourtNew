                        ...
                        <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                                               ...
                                               <br/> <br/> <br/>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <!--<div class="col-sm-6 col-xs-12 tabcontent" id="ShowDiaryRequests">
                                                            <div class="form-group">
                                                                <label class="control-label col-sm-4"> Diary Number:</label>
                                                                <div class="col-sm-4">
                            ...
                            /*                                                $end_year = 48;
                                                        ...
                                                        <div class="panel panel-default tabcontent" id="ShowDiaryRequests">
                                                           ...
                                                           <!-- <div class="form-group">
                                                                <div class="col-md-offset-5" id="submitBtn_dynamicalayDiary" style="display: none">
                                                                    <input type="submit" id="SearchDiaryNumbersubmit" name="add_notice" value="Search" class="btn btn-success SearchDiaryNumbersubmit">
                            
                            
                                                                </div>
                            
                                                                <div class="col-md-offset-5" id="submitBtn_dynamicalayCase" style="display: block">
                                                                    <input type="submit" id="SearchCaseNumbersubmit" name="add_notice" value="Search" class="btn btn-success SearchCaseNumbersubmit">
                                                            ...
                                                            <div class="col-sm-8 col-xs-12">
                                                                <div class="form-group">
                                                                    <div class="col-sm-12 col-xs-12" style="margin-top: 30px;">
                                                                        <div style="width: fit-content;padding-left: 10px;">
                                                                            <!--<label class="radio-inline input-lg"> Pending With Advocate/PIP : <span style="color: blue">  </span></label>
                                                                            <label class="radio-inline input-lg"> Pending With Registry : <span style="color: red"</span> </label>-->
                                                                            <button type="button" class="btn btn-lg btn-primary"> Pending With Advocate/PIP <span class="badge"> {{isset($pending_with_aor)?$pending_with_aor :''}}</span></button>
                                                                            <button type="button" class="btn btn-lg btn-danger"  data-toggle="modal" data-target="#myModal"> Pending With Registry <span class="badge">{{isset($pending_with_registry)?$pending_with_registry :''}}</span></button>
                                                                        </div>
                                                                    </div>
                                                                    <div class="container">
                                                                        ...
                                                                        <div class="modal-body">
                                                                            <span id="customErrorMessage" style="text-align: center">
                                                                               ...
                                                                               <!--<ul style="font-weight: bold;">
                                                                                ...
                                                                                <table border="1" width="100%"><th style="text-align: center">Pending Since</th><th style="text-align: center">Total</th>
                                                                                @if(isset($day_wise_pending))
                                                                                    <tr><td>Total </td><td> <?=$day_wise_pending[0]->total?></td></tr>
                                                                                   <tr><td><1 Day </td><td> <?=$day_wise_pending[0]->zero_day?></td></tr>
                                                                                   <tr><td>>1 Day </td><td> <?=$day_wise_pending[0]->one_day?></td></tr>
                                                                                   <tr><td>2 Days </td><td> <?=$day_wise_pending[0]->two_day?></td></tr>
                                                                                   <tr><td>3 Days </td><td> <?=$day_wise_pending[0]->three_day?></td></tr>
                                                                                   <tr><td>>3 Days </td><td> <?=$day_wise_pending[0]->more_than_three_day?></td></tr>
                                                                                @endif
                                                                            ...
                                                                            <span id="stageWiseBifurcation" style="text-align: center">
                                                                                ...
                                                                                <table border="1" width="100%"><th style="text-align: center">Stage</th><th style="text-align: center">Total</th>
                                                                               <!--<ul style="font-weight: bold;">-->
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <div class="input-group">
                                                                        ...
                                                                        <select name="stage_id" id="stage_id" class="uk-select filter_select_dropdown">
                                                                            <!--<option value="" title="Select">Choose a stage</option>-->
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <div class="input-group">
                                                                        ...
                                                                        <select name="users_id" id="users_id" class="uk-select filter_select_dropdown">
                                                                            <!--<option value="" title="Select">User types</option>-->
                            
                                                                            <?php
                                                                            echo '<option  value="' . htmlentities(url_encryption('All'), ENT_QUOTES) . '" title="Select" selected="selected">All</option>';
                                                                            if(isset($users__types_list)) 
                                                                            {
...
<script>
    $(document).ready(function() {
        /* Code By Amit Mishra Start */
        $("#ShowEfilingRequests").hide();
        /* Code By Amit Mishra End */
