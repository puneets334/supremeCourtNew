    ...
    <div class="form-row">
        ...
        <div class="col-md-4">
            <div class="input-group mb-3">
                ...
                <input type="text" class="form-control" value="<?= $first_name ?>" id="modal_applicant_first_name" aria-labelledby="applicant_first_name_addon"  required>
        ...
        <div class="col-md-4">
            <div class="input-group mb-3">
                ...
                <input type="text" class="form-control" value="<?= $second_name ?>" id="modal_applicant_second_name" aria-labelledby="applicant_second_name" required>
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="input-group mb-3">
                ...
                <input type="text" class="form-control" value="<?= $pincode ?>" id="modal_pincode" aria-labelledby="pincode_addon" maxlength='6' onkeypress="return isNumber(event)" required>
            </div>
        </div>
    ...
    <div class="form-row">
        <div class="col-md-4">
            <div class="input-group mb-3">
                ...
                <input type="text" class="form-control" value="<?= $address ?>" id="modal_postal_add" aria-labelledby="postal_add_addon"  required>
            </div>
        </div>
        <div class="col-md-4">
            <div class="input-group mb-3">
                ...
                <input type="text" class="form-control" value="<?= $city ?>" id="modal_applicant_city" aria-labelledby="applicant_city_addon"  required>
            </div>
        </div>
        <div class="col-md-4">
            <div class="input-group mb-3">
                ...
                <input type="text" class="form-control" value="<?= $district ?>" id="modal_applicant_district" aria-labelledby="applicant_district_addon"  required>
            </div>
        </div>
    </div>
    ...
    <div class="form-row">
        <div class="col-md-4">
            <div class="input-group mb-3">
                ...
                <input type="text" class="form-control" value="<?= $state ?>" id="modal_applicant_state" aria-labelledby="applicant_state_addon" required>
            </div>
        </div>
        <div class="col-md-4">
            <div class="input-group mb-3">
                ...
                <input type="text" class="form-control" id="modal_applicant_country" aria-labelledby="applicant_country_addon" value="<?= $country ?>"  required>
            </div>
        </div>
    </div>
</div>
