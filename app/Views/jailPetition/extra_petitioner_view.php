    ...
    <div class="panel-body">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="form-group">
                    ...
                    <div class="col-md-7 col-sm-12 col-xs-12">
                            <select tabindex = '1' name="prisoner_list" id="prisoner_list" class="form-control input-sm filter_select_dropdown" style="width: 100%">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-xs-12">
                        <div class="form-group">
                            ...
                            <div class="col-md-7 col-sm-12 col-xs-12">
                                <div class="input-group">
                                    <input tabindex = '7' class="form-control has-feedback-left" id="petitioner_dob" name="petitioner_dob" value="<?php echo_data($petitioner_details[0]['party_dob'] ? date('d/m/Y', strtotime($petitioner_details[0]['party_dob'])) : ''); ?>" maxlength="10" readonly="" placeholder="DD/MM/YYYY"  type="text">
        ...
        <div class="form-group">
            <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-4">
                ...
                <input type="submit" tabindex = '19' class="btn btn-success" id="res_save" value="UPDATE">
                <?php }else{ ?>
                <input type="submit" class="btn btn-success"  tabindex = '18' id="res_save" value="SAVE">
                <?php } ?>                
                <a href="<?= base_url('jailPetition/Subordinate_court') ?>" class="btn btn-primary" tabindex = '20' type="button">Next</a>
            </div>
        </div>        
        <?php echo form_close();
        ?>  
    ...
    $(document).ready(function () {
        ...
        $('#add_extra_party').on('submit', function () {
            ...
            if ($('#add_extra_party').valid()) {
                ...
                $.ajax({
                    type: "POST",
                    url: '<?php echo base_url('jailPetition/Extra_petitioner/add_extra_party'); ?>',
                    data: form_data,
                    async: false,
                    beforeSend: function () {
