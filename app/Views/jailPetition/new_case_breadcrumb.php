                    ...
                    <div class="x_panel x-panel_height">
                        ...
                        <div class=" col-lg-8 col-md-8 col-sm-6 col-xs-12 text-right">
                            ...
                            if (($_SESSION['login']['ref_m_usertype_id'] == USER_ADMIN) && in_array($_SESSION['efiling_details']['stage_id'], $Array)) {
                                if($_SESSION['login']['id']!=2660){
                                ?>
                                <a data-toggle="modal" href="#transferModal" class="btn btn-success btn-sm">Transfer to Sec-X</a>
                                    <?php } ?>
...
/*                                if (isset($_SESSION['efiling_details']['efiling_no']) && !empty($_SESSION['efiling_details']['efiling_no'])) {
                        ...
                        if (in_array($_SESSION['login']['ref_m_usertype_id'], array(JAIL_SUPERINTENDENT))) {
                            $data['url_case_detail'] = base_url('jailPetition/BasicDetails');
                            $data['url_extra_petitioner'] = base_url('jailPetition/Extra_petitioner');
                            $data['url_subordinate_court'] = base_url('jailPetition/Subordinate_court');
                            $data['url_case_upload_docs'] = base_url('uploadDocuments');
                            $data['url_case_affirmation'] = base_url('affirmation');
                            $data['url_case_view'] = base_url('jailPetition/view');
                        }  else {
                            $data['url_case_detail'] = $data['url_extra_petitioner']  = $data['url_subordinate_court'] = $data['url_case_sign_method'] = $data['url_case_upload_docs'] = $data['url_case_affirmation'] = $data['url_case_view'] = '#';
                        }

                        $this->load->view('jailPetition/new_case_appeal_ci_breadcrumb', $data);
                        ?>
