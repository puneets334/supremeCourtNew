                                                    ...
                                                    @foreach ($stage_list as $row)
                                                        ...
                                                        @if ($row->meant_for == 'R')
															...
															<tr>
																...
																<td style="text-align: left!important;"><a href="<?php echo $href; ?>" target="_blank"><i class="fa fa-square dark_blue"></i>
																	{{ isset($row->admin_stage_name) ? $row->admin_stage_name : '' }}</a>
																</td>
																<td> <a href="<?php echo $href; ?>" target="_blank"></i>{{ $total_count }}</a> </td>
															</tr>
                                                        @endif
                                                    @endforeach
                                                @endif
...
.first-th-left th:first-child  , .first-th-left td:first-child{padding-left: 15px!important;text-align:left!important}
