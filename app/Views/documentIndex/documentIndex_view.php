<div class="row">
    <div class="panel panel-default panel-body">
        ...
        <div class="col-sm-6 col-xs-12 panel panel-default panel-body">
            <?php $this->load->view('uploadDocuments/upload_document');?>
            <!--<div id="petition-content-viewer-section" style="height: 800px;width: 90%;"></div>-->
        </div>
<?php if (!empty($uploaded_docs) && !empty($uploaded_pdf)){ ?>
        <div class="col-sm-6 col-xs-12 panel panel-default panel-body">
            ...
            <div class="form-group main_div_show">
                ...
                <div class="col-sm-9">
                    ...
                    <select id="doc_type" name="doc_type"  class="form-control input-sm filter_select_dropdown" style="width: 100%" onchange="getindxmodelcopies()" required>
            ...
            <div class="form-group main_div_show" id="subItemData">
                <label class="control-label col-sm-3 input-sm"> Index Sub Item <span style="color: red">*</span>:</label>
                <div class="col-sm-9">
