...
<div id="container">
    ...
    <div id="body">
        ...
        echo '<input type = "hidden" name = "docType" value = "'.$signer_list[0]['doc_type'].'" />';
        echo '<input type = "hidden" name = "esignIndex" value = "'.$sign_count.'" />';
        echo '<input type = "hidden" name = "employeeName" value = "'.$signer_list[0]['email'].'" />';
        echo '<input type = "hidden" name = "employeeCode" value = "-" />';
        echo '<input type = "hidden" name = "employeeDesignation" value = "-" />';
