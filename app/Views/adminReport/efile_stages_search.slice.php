...
<div class="right_col" role="main">
    <div class="row" id="printData">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2><i class="fa fa-edit"></i> Manage E-file Stages</h2>
                            ...
                            <form action="{{base_url('adminReport/EfileStages/search')}}" method="GET">
                                <div class="col-md-4 col-sm-4 col-xs-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="{{isset($efileno) ? $efileno:'' }}"
                                            onfocus="this.value=''" name="efileno" id="efileno" class="form-control">
                                    </div>
                                </div>
