<?php
if (!empty($clerkData[0]['m_city'])) {
    $depcity = $clerkData[0]['m_city'];
} else {
    $depcity = '';
}if ($clerkData[0]['m_pincode'] != 0) {
    $deppincode = $clerkData[0]['m_pincode'];
} else {
    $deppincode = '';
}
?>
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-7">
                                                <div class="input-group">
                                                    <textarea name="address" id="address" placeholder="H.No.,  Street no,  City " class="form-control input-sm"  tabindex="6"><?php echo htmlentities($clerkData[0]['m_address1'], ENT_QUOTES); ?></textarea>
                                            ...
                                            <div class="col-md-7 col-sm-12 col-xs-12">
                                                <select name="states_id" id="states_id"  class="form-control input-sm filter_select_dropdown" tabindex="8">
                                                    ...
                                                    foreach ($states as $state) {
                                                            ...
                                                            if ($clerkData[0]['m_state_id'] == $state->state_code) {
                                                                $selected = 'selected';
                                                            } else {
                                                                $selected = '';
                                                            }
                                            ...
                                            <div class="col-md-7 col-sm-12 col-xs-12">
                                                <select name="district" id="district"  class="form-control input-sm filter_select_dropdown" tabindex="8">
                                                    ...
                                                    foreach ($district as $district) {
                                                            if ($clerkData[0]['m_district_id'] == $district->dist_code) {
...
//                                        }
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-4">
                                <button onclick="location.href = '<?php echo base_url('add/clerk'); ?>'" class="btn btn-primary" type="reset">Cancel</button>
                                <?php if ($clerkData[0] == '') { ?>
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($clerk_user_list as $dataRes) {
                                            ...
                                            if (!empty($dataRes['m_city'])) {
                                                ...
                                                $state = '';
                                            }if ($dataRes['m_pincode'] != 0) {
                                                $pincode = $dataRes['m_pincode'];
                                            } else {
                                                $pincode = '';
                                            }
                                            ...
                                            <tr>
                                                ...
                                                <td width="10%"><?php echo htmlentities($dataRes['m_address1'] . ',' . $city.'-'.$pincode, ENT_QUOTES); ?></td>
                                                <!--<td width="6%"><?php /*echo htmlentities($is_case . '/ ' . $is_doc, ENT_QUOTES); */?></td>-->
                                                <td width="8%"><?php echo date("d/m/Y h:i:s A", strtotime(htmlentities($dataRes['created_on'], ENT_QUOTES))); ?></td>
                                                <td width="12%">
                                                    <a href="<?php echo base_url('add/clerk/edit/'); ?><?php echo htmlentities(url_encryption(trim($dataRes['clerk_id']), ENT_QUOTES)) ?>"  class="btn btn-warning btn-xs" title="Edit" style="<?php echo $display; ?>"> Edit</a>
                                                    <a href="<?php echo base_url('add/clerk/action/');?><?php echo htmlentities(url_encryption(trim($dataRes['clerk_id']), ENT_QUOTES)) ?>/<?php echo htmlentities(url_encryption($status_val), ENT_QUOTES); ?>" onclick="return confirm('Are you sure you want to do this action ?')"><?php echo $action; ?></a>
                                                </td>   
                                            </tr>
                                        <?php } ?>
                                    </tbody>
...
<script>
    $('#states_id').change(function () {
        ...
        $.ajax({
            ...
            url: "<?php echo base_url('add/Clerk/get_district_list'); ?>",
