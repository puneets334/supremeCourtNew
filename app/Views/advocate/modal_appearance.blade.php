...
<div class="modal-body">
    ...
    @else
        ...
        @else
            ...
            <div class="row">
                <div class="col-md-12">
                        ...
                        <div class="card-body">
                            ...
                            <form>
                                ...
                                <div class="input-group">
                                    <select class="form-control" id="advocate_type" name="advocate_type" aria-labelledby="advocate_type_addon" required>
					...
					<option value='Advocate General'>Advocate General</option>
                                    ...
                                    <select class="form-control" id="advocate_title" name="advocate_title" aria-labelledby="advocate_title_addon" required>
                                    ...
                                    <input type="text" name="advocate_name" id="advocate_name" placeholder="Type Name ..." class="form-control">
                            ...
                            <button type="button"
                                    ...
                                    data-courtno="{{$posted_data['courtno']}}"
                                    data-brd_slno="{{$posted_data['brd_slno']}}"
                                    name="btn_save" type="button" class="btn_save btn btn-primary">Add</button>
                            </span>
            ...
            <div class="row display_master_list justify-content-center">
                        ...
                        <div class="card-body p-0">
                            ...
                            @if($added_data)
                                <table class="table_added_advocates table table-sortable" >
                                    ...
                                    @foreach($added_data as $added_data)
                                        <tr>
                                            ...
                                            <td class="text-right py-0 align-middle">
                                                ...
                                                <div class="btn-group btn-group-sm advocate_remove_{{$added_data->id}}">
                                                    <a href="#" data-next_dt="{{$posted_data['next_dt']}}" data-id="{{$added_data->id}}" data-is_active="{{$added_data->is_active}}" class="@if($added_data->is_active == 1) btn-danger @else btn-warning @endif btn advocate_remove" title="@if($added_data->is_active == 1) Click to Remove @else Click to Restore @endif">
                                                        @if($added_data->is_active == 1)
