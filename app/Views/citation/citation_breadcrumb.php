                    ...
                    <div class="x_panel">
                        <div class="x_title">
                            <div class="registration-process" style="float: left; border: none;">
                                <h2><i class="glyphicon glyphicon-book"></i> Citation </h2>
                        ...
                        <div class="x_content">
                            ...
                            if ($_SESSION['login']['ref_m_usertype_id'] == USER_ADVOCATE || $_SESSION['login']['ref_m_usertype_id'] == USER_IN_PERSON) {
                                ...
                                //$listing = base_url('mentioning/Listing');
                                $citation = base_url('citation/CitationController');
                            ...
                            <ul class="nav-breadcrumb">
                                <li> 
                                    ...
                                    } elseif (in_array(MEN_BREAD_CASE_DETAILS, $StageArray)) {
                                ...
                                <li>  
                                    ...
                                    <?php
                                    if ($this->uri->segment(1) == 'citation') {
                                        $ColorCode = 'background-color: #01ADEF';
                                        $status_color = 'first active';
                                    } elseif (in_array(MEN_BREAD_LISTING, $StageArray)) {
                                        $ColorCode = 'background-color: #169F85;color:#ffffff;';
                                        $status_color = '';
                                    } else {
                                        $ColorCode = 'background-color: #C11900;color:#ffffff;';
                                    ...
                                    ?>
                                    <a href="<?= $citation; ?>" class="<?php echo $status_color; ?>" style="z-index:7;"><span style="<?php echo $ColorCode; ?>">2</span> Citation</a>
