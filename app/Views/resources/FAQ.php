                    ...
                    <div id="accordion">
                        ...
                        <div>
                            <div id="accordion1">
                                ...
                                <div>
                                    <!--<p>
                                        To register on eFiling Portal (https://efiling.sci.gov.in/), one can choose to register as an ‘AOR’ (Advocate on Record) or as an ‘Arguing Counsel’ or as a ‘Petitioner-in-Person’ (PIP). After selecting the appropriate registration option enter your Mobile number and email address that you wish to register. Also fill up the captcha displayed, alternatively the facility of Audio captcha is also provided. Afterwards click on ‘Send OTP’. Enter both OTPs i.e., email OTP and mobile number OTP to complete the process of registration.
                                    </p>-->
                                    ...
                                    Once new password is set, the AOR can login by using his AOR code or registered mobile number or registered email id along with the new password.</p>
                                      <div style="text-align: center"><img src="/uploaded_docs/faq_images/1.png" alt="Registration" align="center"></div>
                                ...
                                <div>
                                    ...
                                    <div style="text-align: center"><img src="/uploaded_docs/faq_images/3.png" alt="Registration" align="center"></div>
                                    <img/>
                        ...
                        <div>
                            <div id="accordion2">
                                ...
                                <div>
                                    ...
                                    <div style="text-align: center"><img src="/uploaded_docs/faq_images/4.png" alt="Registration" align="center"></div>
                                ...
                                <div>
                                    ...
                                    <div style="text-align: center"><img src="/uploaded_docs/faq_images/5.png" alt="Registration" align="center"></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            <div id="accordion3">
                                ...
                                <div>
                                    <p>The profile can be viewed by clicking the user icon at the top right corner of the screen.The details of an AOR can be updated through Record Room Section of Supreme Court of India
                                    </p>
                                </div>

                                <h3>07. Can I update my registered mobile number and registered email id?<span class="panel-icon" style="float: right">+</span></h3>
                                <div>
                                    <p>The details of an AOR can be updated through Record Room Section of Supreme Court of India
                                    </p>
                                </div>

                                <h3>08. How can I change my password?<span class="panel-icon" style="float: right">+</span></h3>
                                <div>
                                    <p>You can change the password by clicking on “Change Password” after logging in below the user profile photo.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            <div id="accordion4">
                                ...
                                <div>
                                    <p>Any filed case is available for editing only before final submission. Once submitted, the case will not be available for editing. Please check whether you have already submitted the case.
                                    </p>
                                </div>
                                ...
                                <div>
                                    <p>No. Advocates login provides facility to only view the case details or the cases of his AOR. The case can be filed or refiled only through the login of the AOR.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            <div id="accordion5">
                                ...
                                <div>
                                    <p>Only .pdf file format is allowed for uploading a petition through e-Filing Portal. The maximum file size that can be uploaded is 50 MB. If pdf file size is more than 50MB, file may split into parts for meeting the requirement.
                                    </p>
                                </div>
                                ...
                                <div>
                                    <p>As of now it is not mandatory to sign the petition digitally.
                                    </p>
                                </div>

                                <h3>14. Are there any templates for petitions?<span class="panel-icon" style="float: right">+</span></h3>
                                <div>
                                    <p>It is requested to refer to the Supreme Court Rules, 2013 for the same which are available on the website under the bottom panel of the home page of Supreme Court website.
                                    </p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div id="accordion9">
                                ...
                                <div>
                                    ...
                                    <div style="text-align: center">
                                        <img src="/uploaded_docs/faq_images/26.png" alt="Registration" align="center">
                                    </div>
                                </div>
                               ...
                               <!-- <h3>28. Can I create “My Calendar” for cases?<span class="panel-icon" style="float: right">+</span></h3>
                                <div>
                                    <p>No, this facility is not available.
                                    </p>
                                </div>-->
                                ...
                                <div>
                                    <ol type="i">
                                        ...
                                        <li>My Cases: Cases can be searched by using different filters like Pending matters, Disposed matters, Registered Matters, Unregistered Matters
                                            <div style="text-align: center"><img src="/uploaded_docs/faq_images/29.png" alt="Registration" align="center"></div>
                                        </li>
                                        <li>To add and approve an advocate to view the cases filed on behalf of the AOR
                                            <div style="text-align: center"><img src="/uploaded_docs/faq_images/29-2.png" alt="Registration" align="center"></div>
                                        </li>
                                    </ol>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div style="text-align: center"><img src="/uploaded_docs/faq_images/30.png" alt="Registration" align="center"></div>
                                ...
                                <div>
                                    ...
                                    <div style="text-align: center"><img src="/uploaded_docs/faq_images/31.png" alt="Registration" align="center"></div>
                                ...
                                <div>
                                    ...
                                    <div style="text-align: center"><img src="/uploaded_docs/faq_images/33-1.png" alt="Registration" align="center"></div>
                                    ...
                                    <div style="text-align: center"><img src="/uploaded_docs/faq_images/33.png" alt="Registration" align="center"></div>
                                    ...
                                    <div style="text-align: center"><img src="/uploaded_docs/faq_images/33-2.png" alt="Registration" align="center"></div>
                                    <p><u>Step 4:</u>  Enter the deficit Court fee amount in the box besides ‘want to pay more court fee’ option and submit </p>
                                    <div style="text-align: center"><img src="/uploaded_docs/faq_images/33-3.png" alt="Registration" align="center"></div>
                                </div>
                            </div>
                        </div>
                    </div>
