<?php if(!isset($efiling_search_header)) { $this->load->view('oldCaseRefiling/old_efiling_breadcrumb'); }
...
/*                }
    ...
    <div class="collapse" id="demo_9"> 
        <div class="x_panel">
            ...
            <div class="text-right"><a href="<?php echo base_url('uploadDocuments/DefaultController'); ?>"><i class="fa fa-pencil efiling_search"></i></a></div>
            <?php } ?>
            ...
            if($hidepencilbtn!='true'){ ?>
            <div class="col-sm-1" class="list-group-item" style="background: #EDEDED;" >
                <a href="<?php echo base_url('uploadDocuments/DefaultController'); ?>"><i style="color:black; padding-top:10px;" class="fa fa-pencil efiling_search"></i></a>
            </div>
            <?php } ?>
        </div>
    ...
    <a href="#demo_10" class="list-group-item" style="background: #EDEDED;" data-toggle="collapse" data-parent="#MainMenu"><i class="fa fa-plus" style="float: right;"></i>
        <?php if(!isset($payment_details) || empty($payment_details)){?>
            <font <!--style="color:red;"--> <b>Fees Paid</b></font><?php } else{?> <b>Fees Paid</b><?php } ?></a>
    <div class="collapse" id="demo_10">
        <div class="x_panel">
            <?php
            if($hidepencilbtn!='true'){ ?>
            <div class="text-right"><a href="<?php echo base_url('oldCaseRefiling/courtFee'); ?>"><i class="fa fa-pencil efiling_search"></i></a></div>
            <?php } ?>
            ...
            if($hidepencilbtn!='true'){ ?>
            <div class="col-sm-1" class="list-group-item" style="background: #EDEDED;" >
                <a href="<?php echo base_url('oldCaseRefiling/courtFee'); ?>"><i style="color:black; padding-top:10px;" class="fa fa-pencil efiling_search"></i></a>
            </div>
            <?php } ?>
        </div>
