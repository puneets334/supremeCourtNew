        ...
        <div  id="myFilter" ukfilter="target: .js-filter">
          <table id='example' class="display dataTable uk-table uktable-justify uktable-striped uk-table-hover uk-table-divider" ukfilter="target: .js-filter">
            ...
            <?php if(empty($sr_advocate_data)){ ?>
                <div class="uk-grid-small uk-grid-divider uk-child-width-auto" uk-grid>
                    <div>
                        <ul  class="uk-subnav uk-subnav-pill" uk-margin>
                            <li onclick="AllcasesShowAlert('allcases')" class="uk-active" uk-filter-control><a>All Cases</a></li>
                        </ul>
                    </div>
                    <div>
                        <ul class="uk-subnav uk-subnav-pill" uk-margin>
                            <li uk-filter-control="filter: [data-color='P']; group: data-color" onclick="caseStatusPShowAlert('Pending')">
                                <a>Pending</a></li>
                            <li uk-filter-control="filter: [data-color='D']; group: data-color" onclick="caseStatusDShowAlert('Disposed')"><a>Disposed</a></li>
                        </ul>
                    </div>
                    <div>
                        <ul class="uk-subnav uk-subnav-pill" uk-margin>
                            <li uk-filter-control="filter: [data-size='P']; group: size" onclick="ADVStatusPShowAlert('Appearing for Petitioner')" id="CheckADVStatusP" value="Appearing for Petitioner"><a>Appearing for Petitioner</a></li>
                            <li uk-filter-control="filter: [data-size='R']; group: size" onclick="ADVStatusRShowAlert('Appearing for Respondent')" id="CheckADVStatusR" value="Appearing for Respondent"><a>Appearing for Respondent</a></li>
                            <li uk-filter-control="filter: [reg-st='R']; group: st" onclick="RegStatusRShowAlert('Registered Cases')" id="CheckRegStatusR" value="Registered Cases"><a>Registered Cases</a></li>
                            <li uk-filter-control="filter: [reg-st='U']; group: st" onclick="RegStatusUShowAlert('Unregistered Cases')" id="CheckRegStatusU" value="Unregistered Cases"><a>Unregistered Cases</a></li>
                ...
                <tbody>
                <tr ng-repeat="case in cases" on-finish-render="initialize_cases_data_table" >
                     <td ng-bind="$index + 1">
                        </td>
                    <td>
                    ...
                    <td>
                        ...
                        <div class="uk-padding-small md-bg-grey-700" uk-dropdown="pos:left-center;mode:click;" ng-if="case.status=='P'">
                            <ul class="uknav-parent-icon uk-dropdown-nav"  uk-nav>
                                ...
                                <li ng-if="case.userType =='1'"><a href="{{base_url('case/advocate')}}/@{{case.diaryId}}" class="text-white uknav-divider ukmargin-remove">Engage Sr. Advocate</a></li>
                                ...
                                <!--<li ng-if="diaryWiseRopJudgments[case.diaryId]"><a href="https://main.sci.gov.in/@{{diaryWiseRopJudgments[case.diaryId]['path']}}" target="_blank" class="text-white uknav-divider ukmargin-remove" ng-bind="' Previous Order ('+diaryWiseRopJudgments[case.diaryId]['dated']+')'"></a></li>-->
<!--                                <li><a href="" onClick="open_paper_book()" class="text-white uknav-divider ukmargin-remove" data-diary_no="79922020" data-diary_year="">-->
