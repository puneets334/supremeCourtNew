@if(count($applications))
    <div class="ukcard uk-background-default" uk-drop="mode: click;pos:bottom-justify;boundary: .applications-widget;boundary-align: true;animation:uk-animation-slide-top-medium;" style="border:0.15rem dashed #ccc;border-top:0;">
        <table class="uk-table uk-table-striped uk-table-small uk-table-hover">
            <thead class="md-bg-orange-400">
                <tr>
