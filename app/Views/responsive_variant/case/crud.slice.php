...
<div class="uk-margin-small-top uk-border-rounded">
    <iframe name="content-iframe" class="uk-width internal-content-iframe"  src="{{(empty(@$registration_id) ? base_url((@$tab == 'affirmation' ? @$tab : 'newcase/'.@$tab)) : base_url('newcase/defaultController/'.($registration_id)))}}"></iframe>
</div>
