...
<div class="uk-margin-small-top uk-border-rounded">
    <iframe name="case-document-crud-iframe" class="uk-width internal-content-iframe"  src="{{empty(@$direct_access_params) ? base_url('case/search/'.url_encryption('misc')) : ''}}"></iframe>
</div>
