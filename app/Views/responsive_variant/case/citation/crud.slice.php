...
<!--<form id="case-citation-crud-form" target="case-citation-crud-iframe" method="POST" action="{{base_url('case/search/search_case_details')}}">-->
    <?php
    $attribute = array('id' => 'case-citation-crud-form', 'target' => 'case-citation-crud-iframe');
...
<div class="uk-margin-small-top uk-border-rounded">
    <iframe name="case-citation-crud-iframe" class="uk-width internal-content-iframe"  src="{{empty(@$direct_access_params) ? base_url('case/search/'.url_encryption('citation')) : ''}}"></iframe>
</div>

<script type="text/javascript">
    $(function(){
        $('#case-citation-crud-form').submit();
    });
</script>
