...
<div class="uk-margin-small-top uk-border-rounded">
    <iframe name="case-document-crud-iframe" class="uk-width internal-content-iframe"  src="{{(empty(@$registration_id) ? base_url((@$tab == 'affirmation' ? @$tab : (@$tab == 'courtFee'?'oldCaseRefiling/'.@$tab:'newcase/'.@$tab) )) : base_url('oldCaseRefiling/defaultController/'.($registration_id)))}}"></iframe>
</div>
