...
@section('title', 'e-Filing Login || Register Advocate')
                ...
                <?php echo $this->session->flashdata('msg'); ?>
                        <div class="uk-margin">
                            <div class="uk-inline" style="display: block;">
                                ...
                                <input class="uk-input" type="text" name="adv_mobile"  id="adv_mobile"  placeholder="Mobile"  maxlength="10" minlength="10" onkeyup="this.value=this.value.replace(/[^0-9]/g,'');">
    ...
    $(function(){
       // grecaptcha.ready(function () {
            $("#loginform").one('submit', function (e) {
                var form = this;
                $('[name="ctvrg"]').val('<?=$this->security->get_csrf_hash()?>');
                $(form).submit();
              /*  e.preventDefault();
