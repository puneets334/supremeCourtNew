        ...
        <div class="uk-width uk-text-center">
           ...
           <br><br>
                ...
                <div id="ekyc_upload_share" style="display: none;">
                    ...
                    <input type="hidden" name="adv_type_select" id="adv_type_select" value="<?php echo htmlentities(url_encryption($adv_type_select), ENT_QUOTES); ?>">
                    ...
                    <input hidden id="user_login_type" name="adv_type1" value="<?php echo htmlentities(url_encryption($adv_type_select), ENT_QUOTES); ?>">
                        <p class="uk-margin">
                    ...
                    <div class="uk-margin">
                        ...
                        <div class="uk-margin">
                            <div class="uk-inline" style="display: block;">
                                <span class="uk-form-icon uk-form-icon-flip" uk-icon="icon: user"></span>
                                <input class="uk-input" type="text" name="adv_mobile" id="adv_mobile"  maxlength="10" minlength="10" placeholder="Mobile" onkeyup="this.value=this.value.replace(/[^0-9]/g,'');">
                    ...
                    <?php //echo $this->load->view('Captcha/Captcha_view');?> @include('Captcha.Captcha_view')
