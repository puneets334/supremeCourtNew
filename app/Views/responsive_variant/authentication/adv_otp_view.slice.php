            ...
            <div class="ukwidth-4-5@s ukwidth-3-5@m uk-width-medium@s uk-width-large@m uk-align-center" uk-margin>
                ...
                <?php if ($_SESSION['adv_details']['mobile_no']) { ?>
                        ...
                        <div class="uk-margin">
                            <div class="uk-inline" style="display: block;text-align: left!important;">
                                ...
                                <input class="uk-input" type="text" value="" name="adv_mobile_otp"  placeholder="Enter Mobile OTP" maxlength="6" minlength="6">
                ...
                <div class="uk-margin">
                    <div class="uk-inline" style="display: block;text-align: left!important;">
                        ...
                        <input class="uk-input" type="text" value="" id="adv_email_otp" name="adv_email_otp" maxlength="6" minlength="6" placeholder="Enter Email OTP">
                        <?php echo form_error('adv_mobile'); ?>
                    </div>
                </div>
                <?php } ?>
