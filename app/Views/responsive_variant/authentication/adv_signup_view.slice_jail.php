                    ...
                    <div>
                        <div class="uk-tile uk-tile-mutedww uk-padding-remove" style="padding-bottom: 65px;">
                            ...
                            <div class="uk-column-1-2@s uk-column-1-2@m uk-column-1-2@l uk-text-left">
                                ...
                                <div class="uk-column-1-1@s uk-column-1-1@m uk-column-1-1@l mt22">
                                    <p>Pine Code : <?php echo htmlentities($uid_data_pincode, ENT_QUOTES); ?></p>
                ...
                <div class="uk-child-width-1-1@s uk-grid-small uk-text-center">
                    <div>
                        <!--<form id="uploadForm" action="upload.php" method="post">-->
                            ...
                            echo form_open('upload.php', $attribute);
                            ?>
                            ...
                            <div class="uk-width-1-3@m" >
                                <div class="uk-card uk-card-default uk-card-body" style="background-color: #f7f1dc;padding: 70px;">

                                    <?php if (!empty($_SESSION['profile_image']['profile_photo'])) { ?>
                                        <img  src="<?php echo $_SESSION['profile_image']['profile_photo']; ?>"  height="40" width="50" />
                                    <?php } else if (!empty($_SESSION['kyc_configData']['UidData']['Pht'])) {
                                        ?>
                                        <img  src="<?php echo $user_addar_img; ?>"  height="40" width="50" />
                                        <?php
                                    } else {
                                        echo "NO IMAGE";
                                    }
                            ...
                            <div class="uk-width-expand@m">
                                <div class="uk-card-body uk-text-danger">
                                    ...
                                    <input name="advocate_image" required type="file" value="<?php echo_data($user_addar_img) ?>" class="uk-button uk-button-primary uk-width-1-1 uk-margin-small-bottom">
            ...
            <div class="uk-card-body" style="padding: 0px;">
                ...
                <div class="uk-form-horizontal uk-margin-large">
                    ...
                    <div class="uk-margin">
                        ...
                        <div class="uk-form-controls">
                            <div class="uk-inline">
                                <select name="state_id" id="state_id" class="uk-select" <?php echo $requerd; ?>>
                    ...
                    <div class="uk-margin">
                        ...
                        <div class="uk-form-controls">
                            <div class="uk-inline">
                                <select name="district_list" id="district_list" class="uk-select" <?php echo $requerd; ?> >
                    ...
                    <div class="uk-margin">
                        ...
                        <div class="uk-form-controls">
                            <div class="uk-inline">
                                <span class="uk-form-icon uk-form-icon-flip" uk-icon="icon: question"></span>
                                <input class="uk-input" id="pincode" name="pincode" <?php echo htmlentities($requerd, ENT_QUOTES); ?> value="" placeholder="Pin Code" maxlength="6">
