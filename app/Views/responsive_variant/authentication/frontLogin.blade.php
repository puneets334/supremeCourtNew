                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                                <div class="mb-3">
                                    ...
                                    <input type="password" name="txt_password" class="form-control cus-form-ctrl" id="password" placeholder="Password" maxlength="128" value="<?= session()->getFlashdata('old_password') ? session()->getFlashdata('old_password') : '' ?>" required>
