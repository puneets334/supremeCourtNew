...
@section('title', 'e-Filinf Forget Password Update')
            ...
            <div class="ukwidth-4-5@s ukwidth-3-5@m uk-width-medium@s uk-width-large@m uk-align-center" uk-margin>
                ...
                <div class="uk-margin">
                    <div class="uk-inline" style="display: block;text-align: left!important;">
                        ...
                        <input class="uk-input" type="password" name="password" id="password" maxlength="20" autocomplete="off"  placeholder="Password">
                ...
                <div class="uk-margin">
                    <div class="uk-inline" style="display: block;text-align: left!important;">
                        <span class="uk-form-icon uk-form-icon-flip" uk-icon="icon: lock"></span>
                        <input class="uk-input" type="password" name="confirm_password" id="confirm_password" autocomplete="off" maxlength="20"  placeholder="Confirm Password">
