...
<div class="uk-margin-small-top uk-border-rounded">
    <iframe name="content-iframe" scrolling="no" class="uk-width internal-content-iframe" style="overflow:hidden !important;height: 100vh" src="{{base_url('supplements/Prefilled_index_controller/'.@$method)}}"></iframe>
</div>
