                ...
                <tbody>
                    ...
                    foreach ($petitioner_details as $exp) {
                        ...
                        <tr>
                            ...
                            <?php //print_r($exp);
                            if ($petitioner_details[0]['party_type'] == 'I') { ?>
                            ...
                            <?php } elseif ($petitioner_details[0]['party_type'] == 'D1' || $petitioner_details[0]['party_type'] == 'D2') { ?>
                                <td> <?php echo_data($exp['org_post_not_in_list']=='t'?$exp['org_post_name'].', ':strtoupper($exp['authdesc'].', ')) . echo_data(strtoupper($exp['org_dept_not_in_list']=='t'?$exp['org_dept_name']:$exp['deptname']));?><br/>
