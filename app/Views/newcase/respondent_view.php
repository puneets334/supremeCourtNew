<div class="panel panel-default">
    <h4 style="text-align: center;color: #31B0D5">Respondent  Information </h4>
    <div class="panel-body">
        <?php
        $attribute = array('class' => 'form-horizontal', 'name' => 'add_respondent', 'id' => 'add_respondent', 'autocomplete' => 'off');
        ...
        <div class="col-md-6 col-sm-6 col-xs-12"> 
            ...
            <div id="indvidual_form">
                <div class="row">
                    <div class="col-sm-12 col-xs-12">
                        <div class="form-group">
                            <label class="control-label col-md-5 col-sm-12 col-xs-12 input-sm">Main Respondent Name
            ...
            <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-4">
                ...
                <?php if (isset($_SESSION['case_table_ids']['m_respondent_id']) && !empty($_SESSION['case_table_ids']['m_respondent_id'])) { ?>
                    ...
                    <?php if(isset($IsDeadMinor) && !empty($IsDeadMinor) && $IsDeadMinor=='Y'){?>
                        <!--<a tabindex = '27' href="<?/*= base_url('newcase/actSections') */?>" class="btn btn-primary" type="button">Next</a>-->
                        <a tabindex = '27' href="<?= base_url('newcase/subordinate_court') ?>" class="btn btn-primary" type="button">Next</a>
                    <?php } else { ?>
                        <!--<a tabindex = '27' href="<?/*= base_url('newcase/extra_party') */?>" class="btn btn-primary" type="button">Next</a>-->
                        <a tabindex = '27' href="<?= base_url('newcase/subordinate_court') ?>" class="btn btn-primary" type="button">Next</a>
                    <?php } ?>

                <?php } else { ?>
                    <input tabindex = '24' type="submit" class="btn btn-success" id="res_save" value="SAVE">
                <?php } ?>
            </div>
        </div>
        <?php
