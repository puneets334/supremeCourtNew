                        ...
                        <table id="datatable-responsive1" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                            ...
                            foreach ($court_fee_list1 as $row)  {
                                ...
                                // for Review Petition , Curative Petition,Contempt petition(came from lower court) and MA : Court Fee is to be paid same as having paid in the Main/base Matter
                                {
                                    ...
                                    $subcode1 = !empty($base_case_subject_category_details)?$base_case_subject_category_details['subcode1']:'';
                                    $sc_case_type_id =!empty($base_case_subject_category_details)?$base_case_subject_category_details['case_type_id']:'';
                                }
                                else {
