                ...
                <div class="view_data">
                    ...
                    <div class="x_panel">
                        <div class="x_title">
                            <div class="registration-process" style="float: left; border: none;">
                                <h2><i class="fa fa-file"></i> <?php
                                    ...
                                    } else if($_SESSION['efiling_details']['stage_id']==I_B_Defected_Stage){
                                        echo "ReFiling Form";
                                        $lbl_history = 'eFiling History';
                                    }else {
                                        echo "Case Filing Form";
                        ...
                        if (in_array($_SESSION['login']['ref_m_usertype_id'], array(USER_ADVOCATE, USER_IN_PERSON, USER_PDE))) {
                            $data['url_case_detail'] = base_url('newcase/caseDetails');
                            $data['url_petitioner'] = base_url('newcase/petitioner');
                            $data['url_respondent'] = base_url('newcase/respondent');
                            $data['url_extra_party'] = base_url('newcase/extra_party');
                            $data['url_add_lrs'] = base_url('newcase/lr_party');
                            $data['url_act_section'] = base_url('newcase/actSections');
                            $data['url_subordinate_court'] = base_url('newcase/subordinate_court');
                            $data['url_case_create_index'] = base_url('documentIndex');
                            $data['url_case_upload_docs'] = base_url('uploadDocuments');
                            $data['url_case_courtfee'] = base_url('newcase/courtFee');
                            //$data['url_case_affirmation'] = base_url('affirmation');
                            $data['url_case_view'] = base_url('newcase/view');
                        ...
                        if($_SESSION['efiling_details']['stage_id']==I_B_Defected_Stage || $_SESSION['efiling_details']['stage_id']==I_B_Defects_Cured_Stage)
                            $this->load->view('newcase/refile_case_appeal_ci_breadcrumb', $data);
                        else
                            $this->load->view('newcase/new_case_appeal_ci_breadcrumb', $data);
                        ?>
