...
<ul class="nav-breadcrumb">
    ...
    <li> 
        <?php
        if ($this->uri->segment(2) == 'upload_docs' || $this->uri->segment(1) == 'uploadDocuments' || $this->uri->segment(1) == 'documentIndex') {
            $ColorCode = 'background-color: #01ADEF';
            $status_color = 'first active';
            //$disabled_status='';
        ...
        ?>
        <a href="<?= $url_case_upload_docs ?>" class="<?php echo $status_color; ?>" style="z-index:5;<?php if(!in_array(NEW_CASE_RESPONDENT, $StageArray)){ echo $disabled_status1;} ?>"><span style="<?php echo $ColorCode; ?>">5</span> Upload Document / Index </a>
    </li> 
    ...
    <li> 
        ...
        ?>
        <a href="<?= $url_case_courtfee ?>" class="<?php echo $status_color; ?>" style="z-index:3;<?php if(!in_array(NEW_CASE_RESPONDENT, $StageArray)){ echo $disabled_status1;} ?>"><span style="<?php echo $ColorCode; ?>">6</span> Pay Court Fee </a>
    </li>                        
    ...
    <li> 
        ...
        ?>
        <a href="<?= base_url('newcase/view') ?>" class="<?php echo $status_color; ?>" style="z-index:1;<?php if(!in_array(NEW_CASE_RESPONDENT, $StageArray)){ echo $disabled_status1;}?>"><span style="<?php echo $ColorCode; ?>">7</span>  View </a>
    </li>
</ul>
