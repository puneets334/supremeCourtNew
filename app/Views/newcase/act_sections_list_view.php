        ...
        <div id ="act_section_list_data" class="col-md-12 col-sm-12 col-xs-12">
            <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                ...
                foreach ($act_sections_list as $act_list) {
                    ...
                    $act_section_1 =$act_sectionF[0];
                    $act_section_2=$act_sectionF[1];
                    $act_section_3=$act_sectionF[2];
                    $act_section_4=$act_sectionF[3];
                    ...
                    <tr>
                        ...
                        <?php if($act_list->is_approved == 'Y'){?>
                            <td><?php echo_data(($act_list->act_name) . ' (' . $act_list->act_year . ')'); ?>
                                <!--<button class="btn btn-success btn-sm">Approved</button>-->
                            </td>
                        <?php }else{?>
                            <td><?php  $act_name_Year=echo_data(($act_list->act_name) . $actYear); ?>
                                <b><?php  echo_data('-- Pending for Approval');?></b>
                                <?php $getData_Act=$del_act_id.'@@@'.$act_id.'@@@'.$act_list->act_name.'@@@'.$actYear.'@@@'.$act_section_all;
                                if($_SESSION['login']['ref_m_usertype_id']==USER_ADMIN){?>
                                    <button class="efiling_search btn btn-success btn-sm" data-toggle="modal" href="#act_sections_approveModal" onclick="getDataApprovalModal(<?="'$getData_Act'";?>)">Action Approve</button>
                                <?php }?>
                            </td>
                        <?php }?>
                        <td><?php echo_data($act_list->act_section); ?></td>
                        <?php
                        if($hidepencilbtn!='true'){ ?>
                            <td class="efiling_search"><a onclick="delete_act_section(<?php echo "'$del_act_id'";?>)" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i></a></td>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <center> <button  class="btn btn-success" onclick="update_act_section();">Update</button>
                    <br>OR<br></center>
                 <center>
