...
class AesCipher {
    ...
    */
    static function encrypt($key, $iv, $data) {
        ...
        $encodedEncryptedData = base64_encode(openssl_encrypt($data, AesCipher::OPENSSL_CIPHER_NAME, AesCipher::fixKey($key), OPENSSL_RAW_DATA, AesCipher::fixKey($key)));
    ...
    */
    static function decrypt($key, $data) {
        ...
        //$encrypted = $parts[0];
        //$iv = $parts[1];
        $decryptedData = openssl_decrypt(base64_decode($data), AesCipher::OPENSSL_CIPHER_NAME, AesCipher::fixKey($key), OPENSSL_RAW_DATA, AesCipher::fixKey($key));
